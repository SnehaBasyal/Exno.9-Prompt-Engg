...
## Output:
### Prompt:
On the edge of an enchanted forest, a quiet lantern-maker crafted lights that never burned out. One night, a shimmering firefly landed on his workbench, glowing brighter than any flame. When he captured its light inside a glass sphere, the lantern revealed hidden worlds—floating rivers, invisible creatures, and trees that whispered names of forgotten stars. 
